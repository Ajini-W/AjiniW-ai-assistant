...
def ask_chatbot(query, chat_history=None):
    ...
    # Build system prompt
    system_prompt = (
        f"You are Ajini_W's personal AI assistant. "
        f"Your job is to help users learn about Ajini_W's background, "
        ...
        f"Use the provided excerpts as your primary source of truth for factual information about Ajini_W. "
        ...
        f"Answer in third person when talking about Ajini_W, but you may use natural conversational language "
